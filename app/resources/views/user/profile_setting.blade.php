...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card " style="background-color: #AFE1AF;">
                <div class="card-header bg-primary ">
                    <!-- <h5 class="card-title text-dark"></h5> -->
                    <h5 class=" text-white text-nowrap"><span class="text-white">@lang('Profile') :</span> Your Refferel Link (' http://127.0.0.1:8000/user/register/{{auth()->user()->username}} ')</h5>
                </div>
                <div class="card-body">
