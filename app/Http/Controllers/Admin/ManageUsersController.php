...
class ManageUsersController extends Controller
{
    ...
    public function showNotificationAllFormFtech()
    {
        $general = gs();
        if (!$general->en && !$general->sn) {
            $notify[] = ['warning', 'Notification options are disabled currently'];
        ...
        $users = User::FieldTech()->count();
        $pageTitle = 'Notification to Verified Field Technician';
        return view('admin.users.notification_allftech', compact('pageTitle', 'users'));
    }
