                        ...
                        <ul class="nav nav-treeview mx-3">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('customer.paid.invoice') }}" class="nav-link">
                                    <i class="fas fa-user-plus fa-1x" style="color: teal;"></i>
                                    <!-- Increased size and added red color -->
                                    <p>Paid Invoice List<sup> <span
                                                class="badge badge-success">{{ $paidInvoiceCount }}</span></sup></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('customer.due.invoice') }}" class="nav-link">
                                    <i class="fas fa-list-ul fa-1x " style="color: teal;"></i>
                                    <!-- Increased size and added purple color -->
                                    <p>Due Invoice List<sup><span
                                                class="badge badge-success">{{ $dueInvoiceCount }}</span></sup></p>
                                </a>
                            </li>
                        </ul>
                    </li>
