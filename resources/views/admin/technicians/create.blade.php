                        ...
                        <div class="row">
                            <div class="col-mb-12 d-flex justify-content-between">
                                ...
                                <div class="justify-content-between">
                                    <div class="button btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fas fa-plus-circle"></i> Add Skill</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('technician.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="zip_code" placeholder="Enter zip code" value="{{ old('zip_code') }}">
                                    @error('zip_code')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="primary_contact" placeholder="Enter primary contact" value="{{ old('primary_contact') }}">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="primary_contact_email" placeholder="Enter primary contact's email" value="{{ old('primary_contact_email') }}">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="cell_phone" placeholder="Enter cell phone" value="{{ old('cell_phone') }}">
                                    @error('cell_phone')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="radius" placeholder="Enter radius" value="{{ old('radius') }}">
                                    @error('radius')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="travel_fee" placeholder="Enter travel fee" value="{{ old('travel_fee') }}">
                                    @error('travel_fee')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" class="form-control" name="coi_expire_date" value="{{ old('coi_expire_date') }}">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" class="form-control" name="msa_expire_date" value="{{ old('msa_expire_date') }}">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select name="nda" class="form-control">
                                        ...
                                        <option value="Yes" {{ old('nda') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select name="terms" class="form-control">
                                        ...
                                        <option value="30" {{ old('terms') == '30' ? 'selected' : '' }}>30</option>
                                        <option value="45" {{ old('terms') == '45' ? 'selected' : '' }}>45</option>
                                        <option value="60" {{ old('terms') == '60' ? 'selected' : '' }}>60</option>
                                        <option value="90" {{ old('terms') == '90' ? 'selected' : '' }}>90</option>
                                    </select>
                                    @error('terms')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select name="preference" class="form-control">
                                        <option value="Yes" {{ old('preference') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option selected value="No" {{ old('preference') == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                    @error('preference')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-12 custom-form-group">
                                    ...
                                    <p class="text-danger font-italic custom-description">For multiple select, press Ctrl and click together</p>
                                    <div class="input-group">
                                        <select multiple name="skill_id[]" id="skills" class=" form-control  custom-select" style="height: 200px;">
                                        </select>
                                        @error('skill_id')
                                        <span style="color: red; font-size: 14px" class="custom-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body text-dark">
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" name="skill_name" placeholder="Enter skill name...." id="skill_name">
...
<script>
    $(document).ready(function() {
        ...
        $('#google-autocomplete').on('input', function () {
            var query = $(this).val();
            $.ajax({
                url: "{{ route('distance.places.autoComplete') }}",
                type: "GET",
                data:{
                    "query":query
                },
        ...
        $(document).on('click', '#close-modal', function() {
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(res.skills, function(key, value) {
                        html += '<option  value="' + value.id + '">' + value.skill_name + '</option>';
                    });
