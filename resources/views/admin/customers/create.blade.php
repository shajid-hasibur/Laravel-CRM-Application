                        ...
                        <div class="row">
                            <div class="col-mb-12 col-md-12 d-flex justify-content-between">
                                ...
                                <div class="justify-content-between">
                                    ...
                                    <a class="btn btn-primary" href="{{route('customer.index')}}"><i class="fas fa-list"></i> Go to Customer List</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select name="customer_type" class="form-control">
                                        ...
                                        <option value="Prospecting" {{ old('customer_type') == 'Prospecting' ? 'selected' : '' }}>Prospecting</option>
                                        <option value="Etc" {{ old('customer_type') == 'Etc' ? 'selected' : '' }}>Etc</option>
                                    </select>
                                    @error('customer_type')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input id="state" type="text" class="form-control" name="state" placeholder="Enter state" value="{{ old('state') }}">
                                    @error('state')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="zip_code" placeholder="Enter zip" value="{{ old('zip_code') }}">
                                    @error('zip_code')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="s_rate" placeholder="Standard Rate" value="{{ old('s_rate') }}">
                                    @error('s_rate')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="e_rate" placeholder="Enter Emergency rate" value="{{ old('e_rate') }}">
                                    @error('e_rate')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control" name="travel" placeholder="Enter travel" value="{{ old('travel') }}">
                                    @error('travel')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <select name="billing_term" class="form-control">
                                        ...
                                        <option value="NET30" {{ old('billing_term') == 'NET30' ? 'selected' : '' }}>NET30</option>
                                        <option value="NET45" {{ old('billing_term') == 'NET45' ? 'selected' : '' }}>NET45</option>
                                        <option value="Etc" {{ old('billing_term') == 'Etc' ? 'selected' : '' }}>Etc</option>
                                    </select>
                                    @error('billing_term')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="type_phone" placeholder="Type Of Phone" value="{{ old('type_phone') }}">
                                    @error('type_phone')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="type_wireless" placeholder="Type Of Wireless" value="{{ old('type_wireless') }}">
                                    @error('type_wireless')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="type_cctv" placeholder="Type Of CCTV" value="{{ old('type_cctv') }}">
                                    @error('type_cctv')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="type_pos" placeholder="Type Of POS" value="{{ old('type_pos') }}">
                                    @error('type_pos')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <select name="team" class="form-control" id="">
                                        ...
                                        <option value="Blue Team" {{ old('team') == 'Blue Team' ? 'selected' : '' }}>Blue Team</option>
                                        <option value="Red Team" {{ old('team') == 'Red Team' ? 'selected' : '' }}>Red Team</option>
                                        <option value="Etc" {{ old('team') == 'Etc' ? 'selected' : '' }}>Etc</option>
                                    </select>
                                    @error('team')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="sales_person" placeholder="Sales person assign" value="{{ old('sales_person') }}">
                                    @error('sales_person')
                                    <span style="color:red; font-size:14px">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" name="project_manager" placeholder="Project Manager assign" value="{{ old('project_manager') }}">
