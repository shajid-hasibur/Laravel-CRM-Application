...
<div class="content-wrapper" style="background-color: white;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ url('/customer/customer/zone') }}/{{ $zone->id }}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{ url('/customer/edit/customer') }}/{{ $zone->id }}">About Customer Edit</a></li>
                            <li>
                                <hr class="dropdown-divider">
                                <h6 class="text-center"><span class="badge-danger">Danger Zone</span></h6>
                            </li>
                            <li><a class="dropdown-item" href="{{ url('/customer/delete/customer') }}/{{ $zone->id }}">Delete This Customer</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="d-flex">
                    <div class="button btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Add Site</div>
                    <button class="button btn btn-success m-2" id="siteLoader" data-bs-toggle="modal" data-bs-target="#staticBackdrop1"> Create Work Order</button>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="customer_id" value="{{$zone->id}}" id="customer" readonly>
    ...
    <div class="modal fade text-dark " id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" enctype="multipart/form-data" id="workOrderForm">
                        <div class="row">
                            <input type="hidden" name="slug" value="{{$zone->id}}" id="slug" readonly>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="h_operation" value="{{ old('h_operation') }}" id="h_operation">
                                <span style="color:red; font-size:16px" id="h_operation-error"></span>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="main_tel" class="form-label">Main Telephone</label>
                                <input type="text" class="form-control" name="main_tel" value="{{ old('main_tel') }}" id="main_tel">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="site_contact_name" value="{{ old('site_contact_name') }}" id="site_contact_name">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="site_contact_phone" value="{{ old('site_contact_phone') }}" id="site_contact_phone">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="date_schedule" value="{{ old('date_schedule') }}" id="date_schedule">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="time" class="form-control" name="e_checkin" value="{{ old('e_checkin') }}" id="e_checkin">
                                <span style="color:red; font-size:16px" id="e_checkin-error"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="l_checkin" class="form-label">Latest CheckIn</label>
                                <input type="time" class="form-control" name="l_checkin" value="{{ old('l_checkin') }}" id="l_checkin">
                                <span style="color:red; font-size:16px" id="l_checkin-error"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="instruction" class="form-label">Instruction</label>
                                <textarea name="instruction" class="form-control" cols="30" rows="5" value="{{ old('instruction') }}" id="instruction"></textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="a_instruction" class="form-control" cols="30" rows="5" value="{{ old('a_instruction') }}" id="a_instruction"></textarea>
                                <span style="color:red; font-size:16px" id="a_instruction-error"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="r_tools" class="form-label">Required Tools</label>
                                <textarea name="r_tools" class="form-control" cols="30" rows="5" value="{{ old('r_tools') }}" id="r_tools"></textarea>
                                <span style="color:red; font-size:16px" id="r_tools-error"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="scope_work" class="form-label">Scope Of Work</label>
                                <textarea name="scope_work" class="form-control" cols="30" rows="5" value="{{ old('scope_work') }}" id="scope_work"></textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="arrival" class="form-control" cols="30" rows="5" value="{{ old('arrival') }}" id="arrival"></textarea>
                                <span style="color:red; font-size:16px" id="arrival-error"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="leaving" class="form-label">Before leaving Site</label>
                                <textarea name="leaving" class="form-control" cols="30" rows="5" value="{{ old('leaving') }}" id="leaving"></textarea>
                                <span style="color:red; font-size:16px" id="leaving-error"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="picture" class="form-label">Attached Picture</label>
                                <input type="file" name="pictures[]" class="form-control" id="picture" multiple>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn bg-gray btn-block" id="save1">Save</button><br>
                    <img id="loaderIcon" style="visibility:hidden; display:none; height:50px;" src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif" alt="..." />
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click', '#save1', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#loaderIcon').hide();
                    if (response.message) {
                        $("#slug-error,#site-error,#h_operation-error,#main_tel-error,#site_contact_name-error,#site_contact_phone-error,#date_schedule-error,#e_checkin-error,#l_checkin-error,#instruction-error,#a_instruction-error,#r_tools-error,#scope_work-error,#arrival-error,#leaving-error").empty();
                        ...
                        $("#site,#h_operation,#main_tel,#site_contact_name,#site_contact_phone,#date_schedule,#e_checkin,#l_checkin,#instruction,#a_instruction,#r_tools,#scope_work,#arrival,#leaving,#picture,#documents").val("");
                ...
                error: function(response) {
                    ...
                    if (response.status == 422) {
                        ...
                        $("#slug-error,#site_id-error,#h_operation-error,#main_tel-error,#site_contact_name-error,#site_contact_phone-error,#date_schedule-error,#e_checkin-error,#l_checkin-error,#instruction-error,#a_instruction-error,#r_tools-error,#scope_work-error,#arrival-error,#leaving-error").empty();

                        const fieldsToHandle = ["slug", "site_id", "h_operation", "main_tel", "site_contact_name", "site_contact_phone", "date_schedule", "e_checkin", "l_checkin", "instruction", "a_instruction", "r_tools", "scope_work", "arrival", "leaving"];
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    orders.forEach((item, index) => {
                        ...
                        table.row.add([
                            index + 1,
                            '<a href="" class="order-details" data-id="' + id + '">' + item.order_id + '</a>',
                            '<a href="" class="order-details" data-id="' + id + '">' + item.open_date + '</a>',
                        ]);
                    });
                    table.draw();
                }
