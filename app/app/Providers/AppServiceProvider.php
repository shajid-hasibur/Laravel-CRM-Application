    ...
    public function boot(): void
    {
        ...
        view()->composer('admin.includeNew.sidebar', function ($view) {
            $view->with([
                ...
                'countOp' => WorkOrder::OpenTicket()->count(),
                'countD' => WorkOrder::DispatchedTicket()->count(),
                'countO' => WorkOrder::OnsiteTicket()->count(),
                'countI' => WorkOrder::InvoicedTicket()->count(),
                'countC' => WorkOrder::ClosedTicket()->count(),
