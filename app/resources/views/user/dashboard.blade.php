            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link mt-4" id="site-history-tab" data-bs-toggle="tab" data-bs-target="#home"
                    type="button" role="tab" aria-controls="home" aria-selected="true"><i
                        class="fa-solid fa-stethoscope" style="color: green;margin-bottom:15px;"></i> Site History</button>
            </li>
            <li class="nav-item" role="presentation">
                        ...
                        <div class="card-body mt-4 p-4">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="dropdown mt-3">
                                    <button class="btn btn-primary dropdown-toggle m-2" type="button"
                                ...
                                <div class="col-md-12   d-none" id="generalNote">
                                    <h6>General Notes:</h6><button type="submit"
                                ...
                                <div class="col-md-12   d-none" id="closeOut">
                                    <h6>Closeout Notes:</h6><button class="btn btn-primary m-2"
                                ...
                                <div class="col-md-12  d-none" id="dNote">
                                    <h6>Dispatch Note:</h6><button class="btn btn-primary m-2"
                                        type="submit">Save</button>
                                ...
                                <div class="col-md-12  d-none" id="tNote">
                                    <h6>Tech Support Note:</h6><button class="btn btn-primary m-2"
                                        type="submit">Save</button>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered" id="general-notes-table">
    ...
    <div class="container-fluid d-none" id="fieldTech_view" style="margin-top:-60px">
        <div class="card" style="border-top:none; border-radius:0px">
            <div class="card-header d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-success" id="findClosestTechBtn"><i class="fa fa-magnifying-glass"
                        style="font-size: 13px;"></i>&nbsp;Find Tech</button>
            </div>
            <div class="card-body">
                <div class="row">
